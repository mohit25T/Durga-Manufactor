      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12 relative z-10">
        ...
        <div>
          <div className="mb-6 bg-white/5 inline-block p-4 rounded-2xl border border-white/10">
            <img src="/millzon-logo.png" alt="MillZon Logo" className="h-12 w-auto" />
          </div>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li><Link to="/" className="text-brand-gray hover:text-brand-red transition-colors flex items-center gap-2"><span className="text-xs">▶</span> Home</Link></li>
            <li><Link to="/products" className="text-brand-gray hover:text-brand-red transition-colors flex items-center gap-2"><span className="text-xs">▶</span> All Machines</Link></li>
            <li><Link to="/about" className="text-brand-gray hover:text-brand-red transition-colors flex items-center gap-2"><span className="text-xs">▶</span> About Us</Link></li>
            <li><Link to="/contact" className="text-brand-gray hover:text-brand-red transition-colors flex items-center gap-2"><span className="text-xs">▶</span> Contact Support</Link></li>
          </ul>
        </div>
