        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 items-center gap-16 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-extrabold text-brand-black leading-tight mb-6 tracking-tight">
              Industrial <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-red to-brand-redHover drop-shadow-sm">Food Processing</span><br/>
              Machinery
            </h1>
            ...
            <div className="mt-14 grid grid-cols-2 gap-8 pt-8 border-t border-brand-black/10">
              ...
              >
                ...
                <div>
                  <h4 className="font-extrabold text-brand-black text-lg">15+ Years</h4>
                  <p className="text-sm text-brand-gray font-medium">Manufacturing Excellence</p>
                </div>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <div>
                  <h4 className="font-extrabold text-brand-black text-lg">Pan India</h4>
                  <p className="text-sm text-brand-gray font-medium">Delivery & Support</p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="relative glass-dark rounded-3xl p-3 overflow-hidden shadow-2xl group">
              ...
              >
                ...
                <div>
                  <p className="font-extrabold text-brand-black text-lg tracking-tight">Heavy Duty</p>
                  <p className="text-xs text-brand-red font-bold uppercase tracking-wider">304 Grade Stainless</p>
                </div>
              </motion.div>
            </div>
