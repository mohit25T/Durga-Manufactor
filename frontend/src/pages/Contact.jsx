      ...
      <main className="flex-grow">
        ...
        <section className="bg-brand-slateDark text-white pt-24 pb-48 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
            ...
            >
              Have a custom requirement or need a quote? Reach out to our team
              of experts directly.
            </motion.p>
          </div>
        </section>
          ...
          <div className="glass-dark !bg-white rounded-[2.5rem] shadow-2xl overflow-hidden grid lg:grid-cols-5 flex-col-reverse lg:flex-row border border-brand-slate/10">
            ...
            <div className="lg:col-span-2 bg-brand-slateDark text-white p-8 lg:p-12 relative overflow-hidden flex flex-col justify-between">
              ...
              <div className="relative z-10">
                <h3 className="text-3xl font-bold mb-10 text-brand-amber">
                  Contact Information
                </h3>
            ...
            <div className="lg:col-span-3 p-8 lg:p-12 xl:p-16 bg-white">
              <h3 className="text-3xl font-extrabold text-brand-slateDark mb-2">
                Send us a message
              </h3>
              <p className="text-brand-gray mb-10 font-medium text-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    <label className="text-sm font-bold text-brand-slateDark uppercase tracking-wide">
                      Your Name
                    </label>
                    <input
                      required
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto px-10 py-5 bg-brand-amber hover:bg-brand-amberHover text-brand-slateDark font-bold rounded-xl shadow-xl shadow-brand-amber/20 hover:shadow-brand-amber/40 transition-all flex items-center justify-center gap-3 text-lg"
                >
